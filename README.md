...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-3q6mqhi.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-3q6mqhi.containers.anotherwebservice.com/
...
```
git clone git@github.com:radian462/container-3q6mqhi.git
cd container-3q6mqhi
```
...
```
docker attach container-3q6mqhi
```
